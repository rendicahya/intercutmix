...
```shell
mkdir -p ../data/ucf101/REPP/actorcutmix/mask && cd "$_"
gdown 1Qhb64pXJPy8nUUfWSK0SHqTCSJLwsXcD
tar -xzf ucf101-REPP-mask-actor.tar.gz && rm "$_"

mkdir -p ../../intercutmix/mask && cd "$_"
gdown 1oz6sos92T5fMxja1kgkvKTgyBXq8WO1P
tar -xzf ucf101-REPP-mask-inter.tar.gz && rm "$_"

mkdir -p ../../../../hmdb51/REPP/actorcutmix/mask && cd "$_"
gdown 1LMnCEUUwiy_ni-lj9N-rv5Hnz069n0hl
tar -xzf hmdb51-REPP-mask-actor.tar.gz && rm "$_"

mkdir -p ../../intercutmix/mask && cd "$_"
gdown 1dU6D6GWQ1OfOzOZl8TgYJ2AgK904DHl4
tar -xzf hmdb51-REPP-mask-inter.tar.gz && rm "$_"
```
